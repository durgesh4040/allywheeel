...
import { getSocialLoginUrl, handleLogError } from "../misc/helper";
      ...
      <div className=" relative w-[700px] h-full bg-stone-900 flex flex-col space-y-10 ">
        ...
        <form className="flex flex-col  space-y-10" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row justify-center items-center gap-3 ">
            <a name="github" href={getSocialLoginUrl("github")}>
              <img className=" object-cover " src={facefb} alt="" />
            </a>
            <img className=" object-cover " src={goog} alt="" />
          </div>
          <div className="flex  flex-row justify-center">
            <label className="font-dangrek text-xl">
              <input type="checkbox" className="accent-emerald-400" /> Stay
              signed in
            </label>
          </div>
